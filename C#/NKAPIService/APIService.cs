...
namespace NKAPIService
{
    public class APIService
    {
        ...
        {
            ResponseBase rb = new ResponseBase() { Code = ErrorCode.REQUEST_TIMEOUT };
        ...
        public async Task<bool> IsAnyAG()
        {
            ...
            var responseBase = await Requset(new RequestGetComputingNode());

            return responseBase != null && responseBase.Code == ErrorCode.SUCCESS;
        }
    }
}
